...
2.  **Монитор (Dashboard)**: Открывает панель с текущими настроениями и отношениями агентов.
    
    ![Dashboard](screenshots/agent_dashboard.png)

2.1.  **+Add Bot / Добавить бота**: Кнопка в верхней части панели для добавления нового участника чата.
    
    ![Добавить бота](screenshots/add_bot.png)

3.  **Шестеренка**: Открывает настройки модели и скорости симуляции.
