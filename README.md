...
3.  **+Add Bot / Добавить бота**: Кнопка в верхней части панели для добавления нового участника чата.
    
    ![Добавить бота](screenshots/add_bot.png)

4.  **Шестеренка**: Открывает настройки модели и скорости симуляции.
